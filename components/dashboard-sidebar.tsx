          ...
          <div className="p-4">
            ...
            <div className="space-y-2">
              <Button
                ...
                className="w-full justify-start text-white bg-white/10 hover:text-white hover:bg-white/20 border border-white/20"
              >
              ...
              <Button
                ...
                className="w-full justify-start text-white bg-red-600 hover:text-white hover:bg-red-700"
              >
