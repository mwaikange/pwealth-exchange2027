-- Backfill missing data in buy_orders table to ensure proper display
-- This adds missing shares_requested and shares_filled columns if they don't exist
-- and calculates values for existing orders
...
-- Update status for orders that should be marked as filled
UPDATE buy_orders 
